...
class Pessoa(models.Model):
    ...
    alteracao_cadastral = models.CharField(max_length=1, choices=ENVIOU_DECLARACAO)
    conjuge = models.CharField(max_length=1, choices=ENVIOU_DECLARACAO)
    dependentes = models.IntegerField(null=True)
    conta_banco = models.IntegerField(null=True)
    ...
    pensionista = models.BooleanField()
    previdencia = models.BooleanField()
    dividendos = models.BooleanField()
    prolabore = models.BooleanField()
    exterior = models.BooleanField()
    rra = models.BooleanField()
    outras = models.BooleanField()
    despesasmedicas = models.BooleanField()
    instrucao = models.BooleanField()
    pa = models.BooleanField()
    pc = models.BooleanField()
    doacoes = models.BooleanField()
    outrasdespesas = models.BooleanField()
    imovel = models.BooleanField()
    veiculo = models.BooleanField()
    aplicacaofinan = models.BooleanField()
    acoes = models.BooleanField()
    criptoativos = models.BooleanField()
    participacaosoci = models.BooleanField()
    ouro = models.BooleanField()
    outrosbens = models.BooleanField()
    dividas = models.CharField(max_length=1, choices=ENVIOU_DECLARACAO)
