    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.TextField(error_messages={'required': ''}, max_length=150)),
                ('celular', models.TextField(null=True)),
                ('email', models.EmailField(max_length=254, null=True)),
                ('enviou_declaracao', models.CharField(choices=[('1', 'Sim'), ('0', 'Não')], max_length=1)),
                ('alteracao_cadastral', models.CharField(choices=[('1', 'Sim'), ('0', 'Não')], max_length=1)),
                ('conjuge', models.CharField(choices=[('1', 'Sim'), ('0', 'Não')], max_length=1)),
                ...
                ('dividas', models.CharField(choices=[('1', 'Sim'), ('0', 'Não')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
